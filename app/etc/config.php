...
return [
    'modules' => [
        ...
        'Magento_AdminGwsConfigurableProduct' => 0,
        'Magento_AdminGwsStaging' => 0,
        'Magento_Directory' => 1,
        'Magento_AdobeIms' => 1,
        ...
        'Magento_CheckoutAddressSearch' => 0,
        ...
        'Magento_DeferredTotalCalculating' => 0,
        'Magento_Deploy' => 1,
        'Magento_Developer' => 1,
        'Magento_Dhl' => 1,
        ...
        'Magento_MediaContentCatalogStaging' => 0,
        ...
        'Magento_PageBuilderAdminGwsAdminUi' => 0,
        ...
        'Magento_AsyncOrderGraphQl' => 0,
        'Magento_MultipleWishlistGraphQl' => 0,
        ...
        'Magento_VersionsCmsPageCache' => 0,
        'Magento_VersionsCmsUrlRewrite' => 0,
        'Magento_VersionsCmsUrlRewriteGraphQl' => 0,
        ...
        'Magento_CheckoutAddressSearchGiftRegistry' => 0,
        ...
        'Sync4mage_Catalog' => 0,
        'Sync4mage_CatalogCommerce' => 0,
        'Macron_Sync4mageCatalogWrapper' => 0,
        'Sync4mage_ConfigurableProduct' => 0,
